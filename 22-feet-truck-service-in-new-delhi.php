...
<head>
    ...
    goods transport agency, 22 feet vehicle new delhi, truck 22 feet in delhi,">
        ...
        <div class="about-section">
            <div class="about-content">
                <div class="about-image">
                    <img src="images/tempo-images/22-feet-open-body-truck-new-delhi.jpg" alt="22-feet-open-body-truck-in-new-delhi">
                </div>
                <div class="about-text">
                    <div class="about-heading">
                        <h1>22 Feet Truck Transport New Delhi</h1>
                    </div>
                    <div class="about-para">
                        <p>
                            22 Feet Truck Services For Transportation In New Delhi Is Very Much In Demand. Our Company National Transport Service
                            Provides Both Types Open Body As Well As Close Body 22 Feet Trucks For Household Goods & Industrial or Commercial Goods.
                            Open Body Trucks Are Generally Suitable For Hydra Crane Loading Material. Close Body Trucks Can Not Be Loaded By Hydra Crane
                            As 22 Feet Close Body Truck Is Covered From Top. For Light Goods Like Cartoon Boxes You Can Use 22 Feet Close Body Truck.
                        </p>
                    </div>
                </div>
            </div>
...
<!-- Recent Searches Section Starts Here -->
        ...
        <div class="keywords">
            <a href="index.php">22 Feet Truck New Delhi</a>
            <a href="index.php">Open Body 22 Feet Truck Delhi</a>
            <a href="index.php">Close Body Truck 22 Feet Delhi</a>
            <a href="index.php">Book Truck 22 Feet</a>
            <a href="index.php">Truck Rental Services New Delhi</a>
...
<!-- Recent Searches Section Ends Here -->
        ...
        <div class="row d-flex ms-5 mt-5 m-0 p-0">
            ...
            <div class="col-5 ms-5 tempo-one">
                <img src="images/truck-images/22-feet-truck-open-body-new-delhi.jpg" alt="tempo-image" class="img-fluid">
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-around mt-5 p-0 m-0">
            ...
            <div class="container-fluid">
                <div class="row mt-4">
                    <div class="col-8 ms-5">
                        <img src="images/Vikash-kashyap.png" alt="testimonial-image" class="rounded-circle img-fluid">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h5 class="d-flex justify-content-center mt-4">Vikash Kashyap</h5>
            ...
            <div class="container-fluid">
                <div class="row ms-5 mt-4">
                    <div class="col-9 ms-3">
                        <img src="images/kamlesh-yadav.png" alt="testimonial-image" class="rounded-circle img-fluid">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 justify-content-center">
                        <h5 class="d-flex justify-content-center mt-4">Kamlesh Yadav</h5>
        ...
        <div class="col-3 border border-primary ">
            <div class="container-fluid">
                <div class="row ms-5 mt-4">
                    <div class="col-9 ms-3">
                        <img src="images/vipin-kumar.jpg" alt="testimonial-image" class="rounded-circle img-fluid">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 justify-content-center">
                        <h5 class="d-flex justify-content-center mt-4">Vipin Kumar </h5>
    ...
    <div class="row mt-5 m-0 p-0 justify-content-around">
        ...
        <div class="col-5 border border-dark m-0 p-0 ">
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        <a href="#" class="text-decoration-none">22 Feet Center Truck</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">Truck booking New Delhi to Amritsar</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">22 Feet Truck Tansport New Delhi To Pedum Zanskar Vally Himachal pradesh</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">How To Hire 22 Feet Truck</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-5 m-0 p-0 justify-content-around">
            ...
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        ...
                        <a href="#" class="text-decoration-none">22 Feet Transport Guidence</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="col-5 border border-dark m-0 p-0 ">
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        <a href="#" class="text-decoration-none ">22 Feet Truck </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
