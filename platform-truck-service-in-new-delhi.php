    ...
    <?php include "top-menu.php"; ?>
        ...
        <div class="card-img">
            ...
            <div class="row button-row">
              ...
              <div class="four-btn"><a href="close-body-bolero-pick-up-gurugram.php" class="text-decoration-none">Read More </a></div>
             </div>
        </div>
        <div class="card-img">
            ...
            <div class="row button-row">
              <div class="four-btn"><a href="#" class="text-decoration-none">Book Now</a></div>
              <div class="four-btn"><a href="open-body-bolero-pick-up-truck-New-Delhi.php" class="text-decoration-none">Read More </a></div>
             </div>
        </div>
        <div class="card-img">
        ...
        <div class="about-section">
          <div class="about-image">
            <img src="images/pick-up-trucks/platform-pick-up-removebg-preview (1).png" alt="National-Transport-Company-New-Delhi">
          </div>
