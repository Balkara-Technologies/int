...
<head>
    ...
    <title>Tempo Transport Service New Delhi | Call +91-9289218921</title>
    <meta name="description" content="Tempo Transport Service In New Delhi Is Provided By National Transport Service New Delhi Call +91-9289218921 For Booking. Our Company Provides Tata Ace, Pick Up Truck, 14 Feet Open Body Truck, 17 Feet Open Body Truck, 19 Feet Open Body Truck, 22 Feet Open Body Truck. All Types Of Open Body Truck Available 24x7 From New Delhi To All Over India With Lowest Possible Rates And Best Transport Services.">
    <meta name="keywords" content="Tempo Transport, 14 Feet Truck, 17 Feet Truck, 19 Feet Truck, 22 Feet Truck, Open Body Trucks, Close Body Trucks, Tempo On Hire, Packing, Moving, Loading, Unloading, Unpacking">
            ...
            <div class="about-content">
                ...
                <div class="about-text">
                    <div class="about-heading">
                        <h1>Tempo Transport Service New Delhi</h1>
                    </div>
...
<!-- Recent Searches Section Ends Here -->
        ...
        <div class="row mt-4 ms-5 ps-5 p-0 m-0">
            <div class="col-10">
                <a href="#" class="text-decoration-none">
                    <h1 class="ms-3">TATA ACE IN NEW DELHI</h1>
                </a>
            </div>
        </div>
        ...
        <div class="row mt-4 ms-5 ps-5 p-0 m-0">
            <div class="col-10 m-0 p-0">
                <a href="#" class="text-decoration-none">
                    <h2 class="text-end fs-1">PICKUP TRUCK IN NEW DELHI</h2>
                </a>
            </div>
        </div>
        ...
        <div class="row mt-5 ps-2 me-0">
            ...
            <div class="col-4 ms-5 ps-5 mt-3 m-0 p-0">
                <img src="images/picup-truck.jpg" alt="pick-up-truck" class="ms-3" style="width: 450px; height:400px">
            </div>
        </div>
        ...
        <div class="row mt-4 ms-5 p-0 m-0">
            <div class="col-10">
                <a href="#" class="text-decoration-none">
                    <h3 class="ms-3 fs-1">14 FEET TRUCK IN NEW DELHI</h3>
                </a>
            </div>
        </div>
        ...
        <div class="row mt-5 ms-5 p-0 m-0">
            <div class="col-4 ms-5">
                <img src="images/14-feet-truck-two.jpg" alt="this is about page image-3" class="ms-3" style="width: 500px; height:400px">
            </div>
        ...
        <div class="row mt-5 ms-5 p-0 m-0">
            <div class="col-10">
                <a href="#" class="text-decoration-none">
                    <h4 class="text-end fs-1">17 FEET TRUCK IN NEW DELHI</h4>
                </a>
            </div>
        </div>
        ...
        <div class="row mt-5 ms-5 p-0 m-0">
            ...
            <div class="col-4 ms-5 ps-5 p-0 m-0">
                <img src="images/17-feet-truck.jpg" alt="this is about page image-4" class="ms-3" style="width: 500px; height:400px">
            </div>
        </div>
        ...
        <div class="row mt-4 ms-5 p-0 m-0">
            <div class="col-10">
                <a href="#" class="text-decoration-none">
                    <h5 class="ms-3 fs-1">19 FEET TRUCK IN NEW DELHI</h5>
                </a>
            </div>
        </div>
        ...
        <div class="row mt-5 ms-5 p-0 m-0">
            <div class="col-4">
                <img src="images/19-feet-truck.jpg" alt="this is about page image-5" class="ms-3" style="width: 500px; height:400px">
            </div>
        ...
        <div class="row mt-4 ms-5 p-0 m-0">
            <div class="col-10">
                <a href="#" class="text-decoration-none">
                    <h6 class="text-end fs-1">22 FEET TRUCK IN NEW DELHI</h6>
                </a>
            </div>
        </div>
        ...
        <div class="row mt-5 ms-5 p-0 m-0">
            ...
            <div class="col-4 ms-5 ps-5 p-0 m-0">
                <img src="images/22-feet-truck.jpg" alt="this is about page image-4" class="ms-3" style="width: 500px; height:400px">
            </div>
        </div>
        ...
        <div class="row justify-content-around mt-5 p-0 m-0">
                ...
                <div class="container-fluid">
                    <div class="row mt-4">
                        <div class="col-8 ms-5">
                            <img src="images/chandran-dongra.jpg" alt="testimonial-image" class="rounded-circle img-fluid">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <h5 class="d-flex justify-content-center mt-4">Chandran Dongra</h5>
                ...
                <div class="container-fluid">
                    <div class="row ms-5 mt-4">
                        <div class="col-9 ms-3">
                            <img src="images/chandresh-dahiya.jpg" alt="testimonial-image" class="rounded-circle img-fluid">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 justify-content-center">
                            <h5 class="d-flex justify-content-center mt-4">Chandresh Dahiya</h5>
            ...
            <div class="col-3 border border-primary ">
                <div class="container-fluid">
                    <div class="row ms-5 mt-4">
                        <div class="col-9 ms-3">
                            <img src="images/charan-dongra.jpg" alt="testimonial-image" class="rounded-circle img-fluid">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 justify-content-center">
                            <h5 class="d-flex justify-content-center mt-4">Charan Dongra</h5>
