...
<head>
    ...
    <title>14 Feet Truck Transport Services New Delhi | Call +91-9289218921</title>
...
<!-- About Section Starts Here -->
        <h1 class="heading-one">14 Feet Truck Service In New Delhi</h1>
            ...
            <div class="container-fluid">
                <div class="row ms-5 mt-4">
                    <div class="col-9 ms-3">
                        <img src="images/arun-gupta.png" alt="testimonial-image" class="rounded-circle img-fluid">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 justify-content-center">
                        <h5 class="d-flex justify-content-center mt-4">Arun Gupta</h5>
    ...
    <div class="row mt-5 m-0 p-0 justify-content-around">
        <div class="col-5 border border-dark m-0 p-0 ">
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        <a href="#" class="text-decoration-none">Logistics Policy In India</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="col-5 border border-dark m-0 p-0 ">
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        <a href="#" class="text-decoration-none">14 Feet Center Truck </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">Truck Booking New Delhi To Amritsar</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">14 Feet Truck Transport New Delhi To Padum Zanskar Valley Himachal Pradesh</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">How To Hire 14 Feet Truck</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-5 m-0 p-0 justify-content-around">
            ...
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        ...
                        <a href="#" class="text-decoration-none">Car Transport Guidance</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">Online Truck Booking Tips</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">Truck Toll Charges In India</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </p>
                </div>
            </div>
        ...
        <div class="col-5 border border-dark m-0 p-0 ">
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        <a href="#" class="text-decoration-none ">14 Feet Truck</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none ">Best Transport</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
