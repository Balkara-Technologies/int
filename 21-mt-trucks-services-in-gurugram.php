...
<head>
    ...
    <title>21 MT Truck Transport New Delhi | Call +91-9289218921</title>    
    <meta name="description" content="21 MT Truck Services In Gurugram Is Provided By National Transport Company New Delhi. Call 9289218921 For 
    21 MT Open Body Truck Online Truck Booking In New Delhi NCR. Safe Secure & Hassle Free Transportation. 
    Safe Cargo Delivery Is Our Prime Motto. Our services One of The Fastest 
    Transportation services in All over india.">
    <meta name="keywords" content="21 MT Trucks, Gurugram Transportation, Best Transporter In Gurugram, Gurugram best cargo movers, 
    Haryana logistics companies , All over india Transportation services , Delhi NO.1 Transportation company ,Online truck booking.">
...
<!-- Recent Searches Section Starts Here -->
        ...
        <div class="keywords">
            <a href="index.php">32 Feet Open Trailer ODC</a>
            <a href="index.php">Trailer Transport Services</a>
            <a href="index.php">Truck Transport Rates In India</a>
            <a href="index.php">Flatbed Trailer Gurugram</a>
            <a href="index.php">Semi Trailer Truck India</a>
...
<!-- Recent Searches Section Ends Here -->
        ...
        <div class="row ms-5 mt-5  p-0 m-0">
            <div class="col-5">
                <img src="images/truck-images/19-feet-truck-new-delhi.jpg" alt="truck-images" class="img-fluid border rounded-circle shadow-lg">
            </div>
