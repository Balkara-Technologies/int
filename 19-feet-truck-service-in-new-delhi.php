        ...
        <div class="about-content">
            ...
            <div class="about-text">
                <div class="about-heading">
                    <h1>19 Feet Truck Transport Sevice New Delhi</h1>
                </div>
                <div class="about-para">
                    <p>
                        19 Feet Open Body Trucks Transportation & 19 Feet Close Body Trucks Transportation In New Delhi Is Now Provided By National Transport 
                        Company New Delhi. Our Company Provide All Types Of Trucks Trailers Containers From New Delhi To NCR Region. 24x7 Online Truck Booking Is 
                        Now Available For Over Dimensional Cargo. 19 Feet Eicher Trucks & Tata Trucks Are Suitable For Industrial Commercial And Household Goods
                        Transportation Services. In 19 Feet Open Body Canter Truck Loading & Unloading By Hydra Crane Is Very Easy. Close Body 19 Feet Container 
                        Trucks Is More Suitable For Forklift & Manual Loading Of Light Weight Goods. 
                    </p>
                </div>
            </div>
        </div>
...
<!-- Recent Searches Section Starts Here -->
        ...
        <div class="keywords">
            <a href="index.php">Online Truck</a>
            <a href="index.php">Transport Trucks</a>
            <a href="index.php">Container Transportation Company</a>
            <a href="index.php">Truck Transport Service In Delhi</a>
            <a href="index.php">Truck 28 Feet</a>
...
<!-- Recent Searches Section Ends Here -->
        ...
        <div class="row d-flex ms-5 mt-5 m-0 p-0">
            <div class="col-6">
                <div class="container-fluid m-0 p-0">
                    <div class="row m-0 p-0">
                        <div class="col-12 mt-2 ms-2 m-0 p-0">
                            <h1 class="mt-4 text-primary">19 Feet Truck Services</h1>
                            <h1 class="mt-2 text-primary">New Delhi</h1>
                        </div>
                    </div>
                    <div class="row m-0 p-0 ms-5">
            ...
            <div class="col-5 ms-5 tempo-one">
                <img src="images/truck-images/19-feet-truck-new-delhi.jpg" alt="tempo-image" class="img-fluid">
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-around mt-5 p-0 m-0">
            ...
            <div class="container-fluid">
                <div class="row mt-4">
                    <div class="col-8 ms-5">
                        <img src="images/manish-sen.png" alt="testimonial-image" class="rounded-circle img-fluid">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h5 class="d-flex justify-content-center mt-4">Manish Sen</h5>
            ...
            <div class="container-fluid">
                <div class="row ms-5 mt-4">
                    <div class="col-9 ms-3">
                        <img src="images/mohit-juneja.png" alt="testimonial-image" class="rounded-circle img-fluid">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 justify-content-center">
                        <h5 class="d-flex justify-content-center mt-4">Mohit Juneja</h5>
        ...
        <div class="col-3 border border-primary ">
            <div class="container-fluid">
                <div class="row ms-5 mt-4">
                    <div class="col-9 ms-3">
                        <img src="images/parveen-kumar.png" alt="testimonial-image" class="rounded-circle img-fluid">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 justify-content-center">
                        <h5 class="d-flex justify-content-center mt-4">Parveen Kumar</h5>
    ...
    <div class="row mt-5 m-0 p-0 justify-content-around">
        ...
        <div class="col-5 border border-dark m-0 p-0 ">
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        <a href="#" class="text-decoration-none">19 Feet Center Truck</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">Truck booking New Delhi to Amritsar</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">19 Feet Truck Tansport New Delhi To Pedum Zanskar Vally Himachal pradesh</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="text-decoration-none">How To Hire 19 Feet Truck</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-5 m-0 p-0 justify-content-around">
            ...
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        ...
                        <a href="#" class="text-decoration-none">19 Feet Transport Guidence</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="col-5 border border-dark m-0 p-0 ">
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <p>
                        <a href="#" class="text-decoration-none ">19 Feet Truck </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
